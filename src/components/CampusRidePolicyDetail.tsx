  ...
  return (
    ...
    >
      ...
      <p className="text-slate-600 leading-relaxed pl-6 text-[11px]">
        Standard campus ride-sharing fare is nominal (<strong>₹10 to ₹20 per student</strong> for e-rickshaws and autos traveling between campus gates, academic blocks, and hostel blocks BH/GH 1–13). Fares are split equally among co-passengers upon boarding. Zero surge pricing or booking fees.
      </p>
    </div>
  );
};
