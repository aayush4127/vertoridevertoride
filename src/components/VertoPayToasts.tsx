...
export const VertoPayToasts: React.FC = () => {
  ...
  return (
    <div className="fixed top-20 right-4 sm:right-8 z-50 flex flex-col gap-3 max-w-md w-full pointer-events-none">
      ...
      {/* 1. VIBRANT FLOATING NEON-RED WARNING TOAST */}
      {neonWarningToast && (
        <div 
        ...
        >
          {/* Neon pulsating background glow */}
          ...
          <div className="relative z-10 flex items-start gap-3.5">
            ...
            <div className="flex-1 space-y-1.5">
              ...
              <p className="text-[11px] text-slate-300">
                Minimum ₹15 is required in your VertoPay wallet for automatic campus pass deduction.
              </p>
      ...
      {/* 2. CUSTOM GREEN PAYMENT SUCCESS NOTIFICATION */}
      {successPaymentToast && (
        <div 
